...
const Profile = () => {
  ...
  return (
    <section className='p-10 flex justify-center'>
      <div className='flex flex-col items-center md:flex-row md:items-start gap-6 shadow p-6 rounded-lg border border-solid border-[rgb(14,141,69)]'>
        ...
        <div className='grid gap-6'>
          ...
          <Link to='/mydetails' className='bg-[rgb(14,141,69)] text-white p-2 rounded text-center h-fit'>Edit your details</Link>
        </div>
